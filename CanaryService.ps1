...
###############################################################################
#                                                                             #
#   File name       TokenService.ps1                                          #
#                                                                             #
#   Description     A Canarytokened service in a standalone PowerShell script #
#                                                                             #
...
#                                                                             #
#                   2024-11:                                                  #
#                   Adapted to support alerting upon service stop             #
#                                                                             #
#                   --------------------------------------------------------- #
...
#    2024-11-11 JIT Jacob@thinkst.com added the Canarytoken behavior          #
#                                                                             #
###############################################################################
#Requires -version 2
...
Param(
  ...
  [Parameter(ParameterSetName='Setup2', Mandatory=$false)]
  [String]$ServiceDescription="Helps protect users from malware and other potentially unwanted software", 
...
if ($SCMStop) {                 #  The SCM tells us to stop the service
  ...
  Invoke-WebRequest -Uri $tokenUrl -UserAgent ($serviceName + ' service token')
